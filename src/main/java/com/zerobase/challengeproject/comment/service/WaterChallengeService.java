...
public class WaterChallengeService {
  ...
  public BaseResponseDto<WaterChallengeDto> addWaterChallenge(WaterChallengeAddForm form, UserDetailsImpl userDetails) {
  ...
  //물마시기 챌린지 전체 확인(challengeId, userDetails)
  //물마시기 챌린지 수정(form, userDetails) -> 챌린지가 시작한경우 불가능
  ...
  private Challenge searchWaterChallenge(Long challengeId) {
