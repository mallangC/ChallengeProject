...
public class MemberService {
     ...
     */
    public MemberProfileDto getProfile(String loginId) {
     ...
     */
    @Transactional
    public MemberProfileDto updateProfile(String loginId, MemberProfileFrom form) {
        Member member = findMemberByLoginId(loginId);
     ...
     */
    @Transactional
    public String changePassword(String loginId, ChangePasswordForm form) {
        Member member = findMemberByLoginId(loginId);
